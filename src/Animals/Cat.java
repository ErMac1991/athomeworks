...
public class Cat extends Animal { //наследуют Animal и переопределяют методы makeSound, eat, toString.

    String food = "Whiskas";
    int counter = 2;

    Cat(String name, int foodCounter, String location, HealthState health){
        super.name = name;
    ...
    @Override
    void makeSound(){
        System.out.println("" + name + " говорит: Мяу!"); // выводит текст, как звучит животное
    }
